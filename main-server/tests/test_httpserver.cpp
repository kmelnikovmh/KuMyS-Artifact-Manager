...
TEST_F(HttpServerTest, HandleValidPostRequest) {
    ...
    request_body[U("id")] = json::value::string("123");
    request_body[U("request_type")] = json::value::string("install");
    request_body[U("name")] = json::value::string("test-pkg");
